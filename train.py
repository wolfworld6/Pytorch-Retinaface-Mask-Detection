...
from data import FaceMaskDetection, detection_collate, preproc, cfg_mnet, cfg_re50
...
parser.add_argument(
    "--training_dataset",
    default="./data/kouzhao/train/labels.txt",
...
num_classes = 3  # [bg=0, face without mask=1, face with mask=2]
...
def train():
    ...
    dataset = FaceMaskDetection(training_dataset, preproc(img_dim, rgb_mean))
    ...
    for iteration in range(start_iter, max_iter):
        ...
        if iteration % 5 == 0:
            print(
                "Epoch:{}/{} Iter: {}/{} Loc_loss: {:.4f} Class_loss: {:.4f} LR: {:.8f} Batchtime: {:.4f} s ETA: {}".format(
                    epoch,
                    max_epoch,
